...
const UpdatePlace = () =>{
    ...
    useEffect (()=>{
        ...
        try {
            const responseData = await sendRequest(`http://localhost:5100/api/places/${placeId}`);
    ...
    const placeUpdateSubmitHandler = async event =>{
        ...
        try {
            await sendRequest(`http://localhost:5100/api/places/${placeId}`,
            'PATCH',
            JSON.stringify({
            ...
            }),
            {
                ...
                Authorization: 'Anshu ' + auth.token
            }
            );
